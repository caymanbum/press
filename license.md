...
4. **Edit the URL:**  
   **IMPORTANT:** Before pressing Enter, replace `iguana_id` in the URL with your actual Iguana ID.  
   _Example:_  
   ```
   https://license.interfaceware.com/license?id=12345-ABCDE
   ```
...
## Need Help or a Permanent License Code?

If you need a permanent license code, or if you experience any difficulties, please contact us at [license@interfaceware.com](mailto:license@interfaceware.com).
